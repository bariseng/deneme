...
import { Shield, Plus, Clock, ArrowLeft, ChevronRight } from "lucide-react";
...
export default function SigortaListClient() {
  const [items, setItems] = useState<InsuranceReq[]>([]);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Sigorta Talepleri</h1>
          </div>
          <Link
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-xl border p-12 text-center">
            ...
            <p className="text-gray-500 mb-4">Henüz sigorta talebi oluşturmadınız.</p>
            <Link
              href="/finans/sigorta/yeni"
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm font-medium"
            >
          ...
          <div className="space-y-3">
            {items.map((item) => {
              ...
              return (
                <Link key={item.id} href={`/finans/sigorta/${item.id}`} className="block">
                  <div className="bg-white rounded-xl border p-5 hover:border-purple-300 hover:shadow-sm transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                          <span>Teminat: {formatTRY(item.coverageAmount)}</span>
